...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    floatingBadgeSubtitle: Schema.Attribute.String;
    floatingBadgeTitle: Schema.Attribute.String;
    ...
    leaderBio: Schema.Attribute.Text;
    leaderImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    leaderName: Schema.Attribute.String;
    leaderQuote: Schema.Attribute.Text;
    leaderTitle: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::about.about'> &
      Schema.Attribute.Private;
    missionDescription: Schema.Attribute.String;
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    navTiming: Schema.Attribute.String;
    offices: Schema.Attribute.Component<'shared.office', true>;
    phone2Display: Schema.Attribute.String;
    phone2Link: Schema.Attribute.String;
...
export interface ApiImpactStatImpactStat extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    labelLine1: Schema.Attribute.String;
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    textLine1: Schema.Attribute.String;
    textLine2: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
